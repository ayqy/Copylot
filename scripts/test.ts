...
async function run(): Promise<void> {
  ...
  await runStep(startStep('build-pro-route-validation-stability-pack', 'quality'), () =>
    assertDeterministic(
      './node_modules/.bin/ts-node',
      [
      ...
      [
        'docs/evidence/v4-10/stability-pack/copylot-pro-route-validation-stability-v4-10.md',
        'docs/evidence/v4-10/stability-pack/copylot-pro-route-validation-stability-v4-10.json'
      ],
      'Pro route validation stability outputs should be deterministic'
    )
  );
  await runStep(startStep('build-pro-route-validation-verdict-pack', 'quality'), () =>
    assertDeterministic(
      './node_modules/.bin/ts-node',
      [
      ...
      [
        'docs/evidence/v4-11/verdict-pack/copylot-pro-route-validation-verdict-v4-11.md',
  ...
  await runStep(startStep('build-pro-route-validation-campaign-review-pack', 'quality'), () =>
    assertDeterministic(
      './node_modules/.bin/ts-node',
      [
      ...
      [
        'docs/evidence/v4-13/campaign-review-pack/copylot-pro-route-validation-campaign-review-v4-13.md',
